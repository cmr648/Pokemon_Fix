...
#include "Programs/ShinyHunting/PokemonFRLG_Route2RoamerHunter.h"
...
std::vector<PanelEntry> PanelListFactory::make_panels() const{
    ...
    ret.emplace_back(make_single_switch_program<Route2RoamerHunter_Descriptor, Route2RoamerHunter>());
